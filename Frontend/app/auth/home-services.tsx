    ...
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.container}>
        <View style={styles.titleContainer}>
          <Text style={styles.mainTitle}>{t('homeServices.title')}</Text>
          <Text style={styles.mainSubtitle}>{t('homeServices.subtitle')}</Text>
        </View>
            ...
            <View style={styles.productCard}>
              <View style={styles.cardHeader}>
                ...
                <View style={styles.cardTextWrap}>
                  <Text style={styles.cardTitle}>{t('homeServices.bookTitle')}</Text>
                  <Text style={styles.cardDesc}>{t('homeServices.bookDesc1')}</Text>
                  <Text style={styles.cardDesc}>{t('homeServices.bookDesc2')}</Text>
                </View>
              </View>
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => router.push('/auth/register?targetRole=technician' as any)}>
            <View style={styles.productCard}>
              <View style={styles.cardHeader}>
                ...
                <View style={styles.cardTextWrap}>
                  <Text style={styles.cardTitle}>{t('homeServices.registerTechTitle')}</Text>
                  <Text style={styles.cardDesc}>{t('homeServices.registerTechDesc1')}</Text>
                  <Text style={styles.cardDesc}>{t('homeServices.registerTechDesc2')}</Text>
                </View>
              </View>
            </View>
          </TouchableOpacity>
